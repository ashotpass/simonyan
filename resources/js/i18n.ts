...
const dict = {
    hy: {
        ...
        company_name: 'Սիմոնյան և որդիներ',
        company_tagline: 'Փաստաբանական ընկերություն',
        company_footer: 'Սիմոնյան և որդիներ փաստաբանական ընկերություն',
        default_meta_title: 'Սիմոնյան և որդիներ — Փաստաբանական ընկերություն Երևանում',
        default_meta_description: 'Փաստաբանական ընկերություն Երևանում:',
        skip_to_content: 'Բաց թողնել դեպի բովանդակություն',
        about_eyebrow: 'Մեր մասին',
        service_consultation_cta: 'Կապվեք մեզ հետ Ձեր գործի մանրամասների վերաբերյալ խորհրդատվության համար։',
    },
    en: {
        nav_home: 'Home',
        nav_about: 'About',
        ...
        company_name: 'Simonyan and Sons',
        company_tagline: 'Law Firm',
        company_footer: 'Simonyan and Sons Law Firm',
        default_meta_title: 'Simonyan and Sons — Law Firm in Yerevan',
        default_meta_description: 'Law firm in Yerevan.',
        skip_to_content: 'Skip to content',
        about_eyebrow: 'About',
        service_consultation_cta: 'Contact us for a consultation about your case.',
    },
} as const;
